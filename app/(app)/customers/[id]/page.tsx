  ...
  if (error || !customer) {
    return (
      <div className="flex flex-col items-center justify-center py-32 text-center" dir="rtl">
        <h2 className="text-xl font-bold text-ink">لم يتم العثور على العميل</h2>
    ...
    <div className="space-y-6 max-w-5xl mx-auto text-right" dir="rtl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/customers" className="rounded-xl bg-surface-muted p-2 transition-colors hover:bg-surface-subtle">
            <ArrowRight className="w-5 h-5 text-ink-soft" />
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-ink">{customer.customer_name}</h1>
            <p className="font-mono text-sm text-ink-muted">{customer.customer_code}</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
