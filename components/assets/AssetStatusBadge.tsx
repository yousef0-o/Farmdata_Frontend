...
const STATUS_CONFIG: Record<string, { label: string; color: string }> = {
  ...
  in_maintenance: { label: 'قيد الصيانة', color: 'bg-amber-100 text-amber-600 border-amber-200' },
  disposed:       { label: 'مُستبعد',    color: 'bg-red-100 text-red-600 border-red-200' },
  sold:           { label: 'مُباع',      color: 'bg-gray-100 text-gray-700 border-gray-200' },
}
