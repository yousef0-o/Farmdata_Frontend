...
export default function TopBar({
  ...
  return (
    <header className="sticky top-0 z-40 shrink-0 border-b border-border bg-surface/95 px-4 py-3 backdrop-blur supports-[backdrop-filter]:bg-surface/85 transition-all duration-200 sm:px-6 lg:px-8">
